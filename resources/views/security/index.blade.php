...
<style>
    ...
    .keluar {
        --bg-color: #ffd5c9;
        --bg-color-light: #EAB6B4;
        --text-color-hover: #4C5656;
        --box-shadow-color: rgba(203, 81, 85, 0.47);
    }
...
@section('content')
    ...
    <div class="content px-3">
        ...
        <div class="row mb-2">
            ...
            <div class="col-lg-3 col-sm-6 col-xs-6 p-3">
                <a href="{{route('logbookBarangs.index')}}" class="cardz barangkeluar">
                    <div class="overlayz"></div>
                    <div class="circlez">
            ...
            <div class="col-lg-3 col-sm-6 col-xs-6 p-3">
            <a href="{{route('logbooks.index')}}" class="cardz kuning">
                    <div class="overlayz"></div>
                    <div class="circlez">
    ...
    @include('security.modal_keluar')
    @include('security.modal_kembali')
    @include('security.modal_tamu')
