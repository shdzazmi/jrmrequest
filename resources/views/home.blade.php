...
@section('content')
    ...
    <div class="content px-3">
        <div class="row mb-2">
                ...
                <a href="{{ route('salesOrders.index') }}" class="cardz kembali" style="align-items: center; height: 380px;">
                    ...
                    <div class="cardz-footer clearfix">
                        <div class="one-third border-right">
                            <div class="stat text-warning">{{$prosescount}}</div>
                            <div class="stat-value text-dark">Proses</div>
                        </div>

                        <div class="one-third border-right">
                            <div class="stat text-success">{{$selesaicount}}</div>
                            <div class="stat-value text-dark">Selesai</div>
                        </div>

                        <div class="one-third no-border">
                            <div class="stat text-danger">{{$batalcount}}</div>
            ...
            <div class="col-lg-3 col-sm-3 p-3">
                <a href="{{ route('requestbarangs.index') }}" class="cardz kuning" style="align-items: center; height: 380px;">
                    <div class="overlayz"></div>
                    <div class="circlez" style="margin-top: 50px">
                    ...
                    <p style="margin-top: 30px"><b>Request</b></p>
                        ...
                        <div class="one-full no-border">
                            <div class="stat text-dark">{{$requestcount}}</div>
