            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <a class="btn btn-primary float-right"
                       href="{{ route('fileCatalogues.create') }}">
                        Add New
                    </a>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-lg-8">
                <div class="container-fluid">
                    <div class="archive">
                        ...
                        <div class="card shadow">
                            <a href="{{ route('fileCatalogues.index_isuzu') }}"><span class="mailbox-attachment-icon has-img"><img src="https://www.gmkfreelogos.com/logos/I/img/isuzu1.gif" alt="Cover" style="height: 180px"></span></a>
                            <div class="mailbox-attachment-info" style="height:100%;">
                                <a href="{{route('fileCatalogues.index_isuzu')}}" class="mailbox-attachment-name"><i class="fas fa-folder"></i> Isuzu</a>
                                <span class="mailbox-attachment-size clearfix mt-1"></span>
                            </div>
                        </div>
                        {{--==FOLDER==--}}
