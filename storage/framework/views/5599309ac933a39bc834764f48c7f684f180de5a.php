    ...
    <table class="table dataTable display" id="serviceOrders-table">
        ...
        <?php $__currentLoopData = $serviceOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr>
                ...
                <td style="vertical-align: middle"><?php echo e($serviceOrder->uid); ?></td>
                ...
                <td style="vertical-align: middle" class="text-center">
                    <?php if(isset($status->status)): ?>
                        <?php if( $status->status== 'Proses'): ?>
                            <a href="javascript:void(0)" class="badge badge-pill badge-warning text-white" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e($status->status); ?></a>
                            <?php if(Auth::user()->role == "Master" || Auth::user()->role == "Dev"): ?>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="<?php echo e(route("serviceOrders.editStatusAffari", [$serviceOrder->uid, "Batal"])); ?>"><span class="badge badge-pill badge-danger">Batal</span></a>
                                </div>
                            <?php endif; ?>
                        <?php elseif( $status->status== 'Approved'): ?>
                            <a href="javascript:void(0)" class="badge badge-pill badge-success" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e($status->status); ?></a>
                            <?php if(Auth::user()->role == "Master" || Auth::user()->role == "Dev"): ?>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item" href="<?php echo e(route("serviceOrders.editStatusAffari", [$serviceOrder->uid, "Batal"])); ?>"><span class="badge badge-pill badge-danger">Batal</span></a>
                                </div>
                            <?php endif; ?>
                        <?php elseif( $status->status== 'Batal'): ?>
                            <a href="javascript:void(0)" class="badge badge-pill badge-danger"><?php echo e($status->status); ?></a>
                        <?php else: ?>
                            <a href="javascript:void(0)" class="badge badge-pill badge-warning text-white" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e($status->status); ?></a>
                            <?php if(Auth::user()->role == "Master" || Auth::user()->role == "Dev"): ?>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                ...
                <td style="vertical-align: middle" class="text-center">
                    <?php if(isset($status->approve_produk)): ?>
                        <?php if($status->approve_produk != 'false'): ?>
                    ...
                    <?php endif; ?>
                    <?php if(isset($status->approve_produk)): ?>
                        <?php if($status->approve_service != 'false'): ?>
                ...
                <td style="vertical-align: middle" class="text-center" width="120">
                        ...
                        <?php if($status->status != 'Approved'): ?>
                            <?php if(Auth::user()->role=="Master"): ?>
                                <?php if(Auth::user()->divisi == 'Sparepart'): ?>
                                    <?php if($status->approve_produk == 'false'): ?>
                                        <a href="<?php echo e(route('serviceOrders.approveAffari', [$serviceOrder->uid])); ?>" class="btn btn-default btn-xs"><i class="fas fa-check text-green"></i> Approve </a>
                                    <?php else: ?>
                                        <a href="<?php echo e(route('serviceOrders.approveAffari', [$serviceOrder->uid])); ?>" class="btn btn-default btn-xs"><i class="fas fa-times text-red"></i> Cancel </a>
                                    <?php endif; ?>
                    ...
                    <?php endif; ?>
                    <div class='btn-group'>
                        <a href="<?php echo e(route('serviceOrders.showaffari', [$serviceOrder->id])); ?>" class='btn btn-default btn-xs'>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/service_orders/table_affari.blade.php ENDPATH**/ ?>