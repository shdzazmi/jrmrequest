            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item active">Daihatsu</li>
                    </ol>
                    </h5>
                </div>
                <div class="col-sm-6">
...
<?php echo $__env->make('layouts.app', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/file_catalogues/index_daihatsu.blade.php ENDPATH**/ ?>
