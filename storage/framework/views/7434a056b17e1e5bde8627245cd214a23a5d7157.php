            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <a class="btn btn-primary float-right"
                       href="<?php echo e(route('fileCatalogues.create')); ?>">
                        Add New
                    </a>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="archive">
                        ...
                        <div class="card shadow">
                            <a href="<?php echo e(route('fileCatalogues.index_produkgenuine')); ?>"><span class="mailbox-attachment-icon"><i class="far fa-folder"></i></span></a>
                            <div class="mailbox-attachment-info" style="height:100%;">
                                <a href="<?php echo e(route('fileCatalogues.index_produkgenuine')); ?>" class="mailbox-attachment-name"><i class="fas fa-folder"></i> Master Genuine</a>
                                <span class="mailbox-attachment-size clearfix mt-1"></span>
                            </div>
                        </div>

                        <div class="card shadow">
                            <a href="<?php echo e(route('fileCatalogues.index_daihatsu')); ?>"><span class="mailbox-attachment-icon has-img"><img src="https://cdn.iconscout.com/icon/free/png-256/daihatsu-3-202761.png" alt="Cover" style="height: 180px"></span></a>
                            <div class="mailbox-attachment-info" style="height:100%;">
                                <a href="<?php echo e(route('fileCatalogues.index_daihatsu')); ?>" class="mailbox-attachment-name"><i class="fas fa-folder"></i> Daihatsu</a>
                                <span class="mailbox-attachment-size clearfix mt-1"></span>
                            </div>
                        </div>

                        <div class="card shadow">
                            <a href="<?php echo e(route('fileCatalogues.index_isuzu')); ?>"><span class="mailbox-attachment-icon has-img"><img src="https://www.gmkfreelogos.com/logos/I/img/isuzu1.gif" alt="Cover" style="height: 180px"></span></a>
                            <div class="mailbox-attachment-info" style="height:100%;">
                                <a href="<?php echo e(route('fileCatalogues.index_isuzu')); ?>" class="mailbox-attachment-name"><i class="fas fa-folder"></i> Isuzu</a>
                                <span class="mailbox-attachment-size clearfix mt-1"></span>
                            </div>
                        </div>

                        <div class="card mb-2 shadow">
                            <a href="<?php echo e(route('fileCatalogues.index_excel')); ?>"><span class="mailbox-attachment-icon"><i class="far fa-file-excel"></i></span></a>
                            <div class="mailbox-attachment-info" style="height:100%;">
                                <a href="<?php echo e(route('fileCatalogues.index_excel')); ?>" class="mailbox-attachment-name"><i class="fas fa-file-excel"></i> Mitsubishi</a>
                            </div>
                        </div>



                        <?php echo $__env->make('file_catalogues.grid', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/file_catalogues/index.blade.php ENDPATH**/ ?>
