    ...
    <div class="col-md-10 offset-md-1" >
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right">
                        <a class="btn btn-outline-primary"
                           href="<?php echo e(route('salesOrders.index')); ?>">
                            <i class="fas fa-redo-alt"></i> Refresh
                        </a>
                        <a href="<?php echo e(route('salesOrder.dashboard_excel')); ?>" title="Export excel" class='btn btn-outline-primary'>
                            <i class="fas fa-file-download"></i>
                            Export
                        </a>
                        <a class="btn btn-primary"
                           href="<?php echo e(route('salesOrders.create')); ?>">
                            Tambah baru
                        </a>
                    </div>
        ...
        <div class="content px-3">
            ...
            <div class="card card-outline card-primary">
                <div class="card-body">
                    <?php echo $__env->make('sales_orders.table', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/sales_orders/index.blade.php ENDPATH**/ ?>
