            ...
            <div class="modal-body">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <!-- Waktu Field -->
                        <div class="form-group col-sm-6">
                            <?php echo Form::label('waktu', 'Waktu:'); ?>

                            <?php echo Form::text('waktu', null, ['class' => 'form-control','id'=>'waktukembali']); ?>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <?php echo Form::text('keterangan', null, ['class' => 'form-control', 'id' => 'keterangan-kembali']); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/security/modal_kembali.blade.php ENDPATH**/ ?>