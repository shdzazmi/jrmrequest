...
<script>
    ...
    $(document).ready(function() {
        ...
        let tbProduk = $('#serviceorderproduk').DataTable({
            ajax: {
                url: '<?php echo e(URL::to('getserviceOrders')); ?>'
            },
            select: true,
            cache: true,
            serverSide: true,
            ...
            btnconfirm.on('click', function (e, dt, type, indexes) {
                ...
                if (qtyInput.value !== ''){
                    if (rowData !== lastResult) {
                        lastResult = rowData;
                        var url = '<?php echo e(route("serviceOrders.put")); ?>';
                        var data = {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/service_orders/table_produk.blade.php ENDPATH**/ ?>