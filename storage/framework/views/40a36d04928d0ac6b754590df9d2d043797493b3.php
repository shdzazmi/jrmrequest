...
<script>
    ...
    $(document).ready(function() {
        ...
        const tbProduk = $('#jasaservice').DataTable({
            ajax: {
                url: '<?php echo e(URL::to('getservicesOrders')); ?>'
            },
            select: true,
            serverSide: true,
            order: [[1, "asc"]],
        ...
        $('#jasaservice tbody ').on('click', 'tr', function (e, dt, type, indexes) {
            ...
            if (rowData !== lastResult) {
                lastResult = rowData;
                var url = '<?php echo e(route("serviceOrders.puts")); ?>';
                var data = {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/service_orders/table_service.blade.php ENDPATH**/ ?>