...
<div class="card-body table-responsive p-0 pb-2">
    <table style="table-layout: fixed;" class="table dataTable display"  id="tbdaihatsu">
        <thead>
...
<?php $__env->startPush('page_scripts'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#tbdaihatsu tfoot th').each( function () {
                var title = $(this).text();
                $(this).html( '<input type="search" class="form-control"/>' );
            } );

            const tbProduk = $('#tbdaihatsu').DataTable({
                order: [[0, "asc"]],
                autoWidth: false,
                ajax: {
                    url: '<?php echo e(URL::to('produkgenuine-daihatsu')); ?>'
                },
                cache: true,
                serverSide: true,
                processing: true,
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/file_catalogues_genuine/table_daihatsu.blade.php ENDPATH**/ ?>