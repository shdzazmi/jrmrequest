...
<div class="card-body table-responsive p-0 pb-2">
    <table style="table-layout: fixed;" class="table dataTable display"  id="tbhonda">
        <thead>
...
<?php $__env->startPush('page_scripts'); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#tbhonda tfoot th').each( function () {
                var title = $(this).text();
                $(this).html( '<input type="search" class="form-control"/>' );
            } );

            const tbProduk = $('#tbhonda').DataTable({
                order: [[0, "asc"]],
                autoWidth: false,
                ajax: {
                    url: '<?php echo e(URL::to('produkgenuine-honda')); ?>'
                },
                cache: true,
                serverSide: true,
                processing: true,
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/file_catalogues_genuine/table_honda.blade.php ENDPATH**/ ?>