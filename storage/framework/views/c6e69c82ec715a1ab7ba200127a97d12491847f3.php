            ...
            <div class="card-body">
                <div class="tab-content" id="custom-tabs-one-tabContent">
                    <div class="tab-pane fade active show" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                        <?php echo $__env->make('search_produk.table', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
            <!-- /.card -->
                ...
                <div class="modal-body p-3">
                    ...
                    <div class="row">
                        ...
                        <div id="denah3" class="col-sm-12 pb-3" style="display: none">
                            <?php echo $__env->make('location.denah.3', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                        <div id="denah2" class="col-sm-12 pb-3" style="display: none">
                            <?php echo $__env->make('location.denah.2', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
...
<?php echo $__env->make('layouts.app', Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/search_produk/index.blade.php ENDPATH**/ ?>
