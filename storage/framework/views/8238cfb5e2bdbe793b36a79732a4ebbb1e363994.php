...
<p class="a">Bersama ini kami ingin memberikan penawaran harga mengenai Service mobil <b><?php echo e($serviceOrder->mobil); ?></b> sebagai berikut:</p>
...
<table class="table table-nopadding" style="font-size: 12px; border-top: 0 solid white;">
    ...
    <tr>
        ...
        <td style="text-align: center"><b><?php echo e($serviceOrder->approve_service); ?></b></td>
        <td style="text-align: center"><b><?php echo e($serviceOrder->approve_produk); ?></b></td>
    </tr>
    </tbody>
</table>
<br>
...
<?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/service_orders/export/service_orders_pdf_simple.blade.php ENDPATH**/ ?>