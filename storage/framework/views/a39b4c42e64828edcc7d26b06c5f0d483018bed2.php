                ...
                <?php $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class='clickable-row'>
                        ...
                        <td>
                            ...
                            <?php if($item['partno2'] != ""): ?>
                                <span class="badge badge-pill bg-secondary">2</span> <?php echo e($item['partno2']); ?><br/>
                            <?php else: ?>
                        ...
                        <td style="text-align:right">
                            <span class="badge badge-pill bg-info">Toko:</span> <?php echo e($item['qtyTk']); ?><br/>
                            <span class="badge badge-pill bg-info">Gudang:</span> <?php echo e($item['qtyGd']); ?><br/>
                        </td>
                    </tr>
            ...
            btnconfirm.on('click', function (e, dt, type, indexes) {
                ...
                if (qtyInput.value !== ''){
                    if (rowData !== lastResult) {
                        lastResult = rowData;
                        var url = '<?php echo e(route("salesOrder.put")); ?>';
                        var data = {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\jrmrequest\resources\views/sales_orders/table_produk.blade.php ENDPATH**/ ?>